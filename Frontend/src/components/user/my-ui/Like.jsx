        ...
        <div className="icons-box">
          <div className="icons">
            <label className="btn-label" htmlFor="like-checkbox">
              ...
              <input className="input-box" id="like-checkbox" type="checkbox" onChange={handleLike} />
          ...
          <div className="icons">
            <label className="btn-label" htmlFor="dislike-checkbox">
              <input className="input-box" id="dislike-checkbox" type="checkbox" onChange={handleDislike} />
              <div className="fireworks">
...
const StyledWrapper = styled.div`
  .like-dislike-container {
    --dark-grey: #e9e9e9;
    --middle-grey: #10B981;
    --lightest-grey: linear-gradient(#141416,#141416);
    --shadow: 0 5px 15px 0 #00000026;
    --shadow-active: 0 5px 5px 0 #00350026;
