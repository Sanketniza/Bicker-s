...
export default function BikeDetails() {
    ...
    const {singleProduct} = useSelector(state => state.product); // Get the singleProduct from the Redux store state using the useSelector hook and store it in the singleProduct variable.
