...
export default function CompaniesPage() {
  ...
  // Filter products with category "Scooter"
  const scooterProducts = allProducts.filter(product => product.category === 'Scooter');
  console.log("Scooter products:", scooterProducts.length);
      ...
      <div className="mx-10">
        <div className="relative p-10 mx-auto my-20 border rounded-lg shadow-2xl border-emerald-500/30 max-w-7xl bg-black/20 backdrop-blur-sm">
          ...
          <h1 className="relative text-4xl font-bold mb-12 text-white">
            <span className="text-[#6A38C2]">Scooter</span>
          </h1>
          ...
          {scooterProducts.length > 0 ? (
            ...
            <span className="text-xl text-gray-400">No Scooters Found</span>
          )}
        </div>
      </div>
    </div>
